...
export const images = {
  ...
  vitaminsminerals: require('./images/vitaminsminerals.jpg'),
  qualitysleep: require('./images/qualitysleep.jpg'),
  betterkidney : require('./images/betterkidney.jpg'),
  naturaldetox : require('./images/naturaldetox.jpg'),
  fluidlevels: require('./images/fluidlevels.jpg'),
  electrolytebalance: require('./images/ElectrolyteBalance.jpg'),
  energylevels: require('./images/energylevels.jpg'),
  supportheart: require('./images/supportheart.jpg'),
  kidneywellness: require('./images/kidneyfull.jpg'),
  labpackge: require('./images/labpackge.png'),
